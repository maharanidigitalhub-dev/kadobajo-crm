  ...
  return (
    <>
      <style>{`
        ...
        .crm-sidebar {
          width:240px; background:white; border-right:1.5px solid #E8ECF8;
          position:fixed; top:0; bottom:0; left:0; height:100vh;
          display:flex; flex-direction:column; z-index:30;
          font-family:'DM Sans',sans-serif;
        }
        .crm-sidebar-logo {
          padding:20px; border-bottom:1.5px solid #E8ECF8;
        ...
        .crm-logo-name {
          ...
          font-size:14px; color:#1B2A6B; line-height:1;
        }
        ...
        .crm-sidebar-footer {
          padding:12px; border-top:1.5px solid #E8ECF8;
        }
        ...
        <div className="crm-sidebar-footer">
          <div style={{
            ...
            <div style={{
              ...
              color:meta.color, flexShrink:0, fontFamily:"'DM Sans',sans-serif",
            }}>
              {initials}
            </div>
