...
const navItems = [
  { href: '/dashboard',      label: 'Dashboard',         roles: ['superadmin', 'admin', 'manager', 'management'] },
  { href: '/customers',      label: 'Customers',          roles: ['superadmin', 'admin', 'manager', 'management'] },
  { href: '/customers/add',  label: '+ Tambah Customer',  roles: ['superadmin', 'admin', 'manager'] },
  { href: '/customers/bulk', label: 'Import Bulk',         roles: ['superadmin', 'admin', 'manager'] },
  { href: '/cms',            label: 'CMS',                 roles: ['superadmin', 'admin', 'manager'] },
  { href: '/landing-pages',  label: 'Landing Pages',       roles: ['superadmin', 'admin', 'manager', 'management'] },
  { href: '/approval',       label: '🔔 Approval',         roles: ['superadmin', 'manager'] },
  { href: '/users',          label: '👤 Kelola User',      roles: ['superadmin'] },   // SuperAdmin only
];
